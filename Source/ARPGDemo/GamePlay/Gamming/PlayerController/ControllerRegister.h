...
#include "ControllerRegister.generated.h"
 ...
 */
UCLASS()
class ARPGDEMO_API UControllerRegister : public UObject
{
	GENERATED_BODY()
...
public:
	...
	static UControllerRegister* GetInstance();
...
private:
	static UControllerRegister* Instance;
